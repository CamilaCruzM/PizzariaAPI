...
mysql_select_db('dbpizzariafrajolas');
        ...
        if(isset($_POST['btnOk'])){
            ...
            $verificar= mysql_query("SELECT * FROM tbl_usuario  WHERE  usuario = '$usuario' and senha ='$senha' ")
                or die('Erro de Usuario');
            if(mysql_num_rows($verificar)<=0){
                echo"<script language='javascript' type'text/javascript'>alert('Login ou Senha Incorreta'); window.location.href='pizzaria.php.php';</script>";
                die();
        }else{
                 ...
                 <!---menu----->
                    <nav id="menu">
                            <div class="caixa_menu">
                                <a href="pizzaria.php" class="link">
                                    Home
                                </a>
                            </div>
                            <div class="caixa_menu">
                    ...
                    <div id="login">
                    <form name="frmlogin" method="post" action="pizzaria.php" >
                    ...
                    <table id="cad">
                        <tr>
                            ...
                            <tr>
                                <td>Senha</td>
                                <td><input type="password" name="txtsenha" value="" maxlength="10" size="10" placeholder="Digite sua senha" ></td>
